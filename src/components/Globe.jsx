    ...
    const ensureVehicleEntity = useCallback((vehicleData, initialPosition) => {
        ...
        if (!entity) {
            entity = viewer.entities.add({
                ...
                point: {
                    pixelSize: 11,
                    color: Cesium.Color.fromCssColorString(vehicleData.paintColor || '#00ff95'),
                    outlineColor: Cesium.Color.WHITE,
                    outlineWidth: 2,
                    disableDepthTestDistance: 50000,
                },
                label: {
                    text: vehicleData.shortLabel ? `${vehicleData.shortLabel} · ${vehicleData.callsign}` : (vehicleData.name || vehicleData.callsign),
